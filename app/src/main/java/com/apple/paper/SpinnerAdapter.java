...
//        colorlist = new ArrayList<ItemData>();
//        for(int i = 0; i < 5; i++){
//            ImageView img = new ImageView(context);
//            img.setImageResource(R.drawable.color_ticket);
...
//            container.addView(img, i);
//            GradientDrawable drawable = (GradientDrawable) img.getDrawable();
//            drawable.setColor(colorlist.get(i).imageId);
//        }
        return v;
    }
}